        ...
        for(var rule in rules){
            if(i <= rulesNumber){
                if(rules[rule].firstclass == "" && rules[rule].secondclass == "")
                    return false
                else if(rules[rule].firstclass == "Costante" && !rules[rule].firstCostant)
                    return false
                else if(rules[rule].secondclass == "Costante" && !rules[rule].secondCostant)
                    return false                
    ...
    function createExpression(rules,rulesNumber){
        ...
        for(var rule in rules){
            if(i <= rulesNumber){
                var firstItem = ""
                var secondtItem = ""
                if(rules[rule].firstclass != "Costante")
                    firstItem = rules[rule].firstclass           
                else
                    firstItem = rules[rule].firstCostant

                if(rules[rule].secondclass != "Costante")
